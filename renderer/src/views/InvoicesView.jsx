    ...
    <div className="p-4 space-y-4 bg-gray-50 dark:bg-gray-900 min-h-screen">
      <div className="flex items-center justify-between bg-white border border-gray-200 rounded-lg px-4 py-2 shadow-sm">
        <div className="flex items-center justify-between w-full">
          <div>
            <h1 className="text-base font-bold text-gray-800">💰 Invoices</h1>
            <p className="text-xs text-gray-400 ml-2">Building Care Solutions - {invoices.length} Total Invoices</p>
          </div>
          <button
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50" onClick={() => setIsViewModalOpen(false)}>
          <div className="bg-white dark:bg-gray-800 rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl relative" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                <AttachmentsPanel entityType="invoice" entityId={viewingInvoice.id} />
              </div>
            </div>
