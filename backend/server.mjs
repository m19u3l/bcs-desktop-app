...
import squarePaymentsRouter from './routes/square-payments.mjs';
import stripePaymentsRouter from './routes/stripe-payments.mjs';
...
import assembliesRouter  from './routes/assemblies.mjs';
...
app.use('/api/square-payments', squarePaymentsRouter);
app.use('/api/stripe-payments', stripePaymentsRouter);
